...
export default function CategoryEdit({ category }) {
    const [slugManuallyEdited, setSlugManuallyEdited] = useState(true); // Start as true on edit
    ...
    // Handle name change - don't auto-update slug on edit unless user clears it
