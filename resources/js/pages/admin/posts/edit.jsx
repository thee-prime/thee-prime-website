...
import { ArrowLeft, Save, Eye, Sparkles, Check, X, Loader2, ExternalLink } from 'lucide-react';
...
export default function PostEdit({ post, categories }) {
    ...
    const handleTitleChange = (value) => {
        if (!slugManuallyEdited && !data.slug) {
                    ...
                    <div className="flex items-center gap-3">
                        {post.is_published && (
                            <a
                                ...
                                className="flex items-center gap-2 px-4 py-2 rounded-lg border border-slate-700 text-slate-300 hover:text-white hover:bg-slate-800 transition-all"
                            >
                        ...
                        <Link
                            ...
                            target="_blank"
                            className="flex items-center gap-2 px-4 py-2 rounded-lg border border-purple-500/50 text-purple-400 hover:text-purple-300 hover:bg-purple-500/10 transition-all"
                        >
                        ...
                        >
                            ...
                            {aiLoading ? 'Generating...' : '✨ Generate SEO'}
                        </button>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                        ...
                        <div className="lg:col-span-3 space-y-6">
                            <div className="bg-slate-800/50 rounded-xl border border-slate-700/50 p-6">
                                <h2 className="text-xl font-bold text-white mb-6">Edit Post</h2>
